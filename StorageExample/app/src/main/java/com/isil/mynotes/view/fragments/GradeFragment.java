...
import com.isil.mynotes.view.adapters.GradeAdapter;
...
public class GradeFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        lstGrade= (ListView) getView().findViewById(R.id.lstGrade);

        GradeOperations gradeOperations=
                new GradeOperations(new MyDatabase(getActivity()));
        grades= gradeOperations.getAllGrades();

        GradeAdapter gradeAdapter= new GradeAdapter(getActivity(),
                grades);
        lstGrade.setAdapter(gradeAdapter);

        Log.v("CONSOLE", "grades "+grades.size());
    }
}
