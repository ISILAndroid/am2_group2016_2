package com.isil.mynotesorm.view.fragments;
...
public class DetailsFragment extends Fragment {
    ...
    private NoteORMEntity noteORMEntity;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if(getArguments()!=null)
        {
            ...
            noteORMEntity= (NoteORMEntity) getArguments().getSerializable("NOTE");
        }
        if(noteORMEntity!=null)
        {
            //TODO mostrar INFO
            String name= noteORMEntity.getName().toString();
            String desc= noteORMEntity.getDescription().toString();
